      ...
      <div className="container mx-auto px-4 py-16 relative">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
            Create personalized study schedules based on your subjects,
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-16">
          <Card className="p-6 md:p-8 text-center hover:shadow-2xl transition-all duration-300 transform hover:scale-105 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-0">
            ...
            <h3 className="text-lg md:text-xl font-bold mb-4 text-gray-900 dark:text-white">Fully Customizable Study Plan</h3>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-sm md:text-base">Manually add, edit, and organize your study subjects the way you like—full control, no surprises.</p>
          </Card>
          <Card className="p-6 md:p-8 text-center hover:shadow-2xl transition-all duration-300 transform hover:scale-105 bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border-0">
            ...
            <h3 className="text-lg md:text-xl font-bold mb-4 text-gray-900 dark:text-white">Easy Task Management</h3>
            <p className="text-gray-600 dark:text-gray-300 leading-relaxed text-sm md:text-base">Create and manage tasks or sessions with deadlines, priorities, and time estimates.</p>
          </Card>
        </div>
